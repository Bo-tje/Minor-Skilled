...
ALock::ALock()
{
	...
	TriggerComponent = CreateDefaultSubobject<UTriggerComponent>(TEXT("Trigger Comp"));
	TriggerComponent->SetupAttachment(RootComp);
...
void ALock::SetIsKeyPlaced(bool NewIsKeyPlaced)
{
	...
	TriggerComponent->Trigger(NewIsKeyPlaced);
